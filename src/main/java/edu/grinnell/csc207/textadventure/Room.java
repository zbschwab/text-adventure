...
public interface Room {
    ...
    public class Crate implements Room {
        ...
        public Crate(String entrance, String descripIn, String exit, String descripOut) {
    ...
    public class Basement implements Room {
        ...
        public Basement(String entrance, String descripIn, String exit, String descripOut) {
            this.entrance = entrance;
            this.descripIn = descripIn;
            this.exit = exit;
            this.descripOut = descripOut;
